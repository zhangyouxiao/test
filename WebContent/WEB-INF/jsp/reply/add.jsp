...
<!--显示表单内容-->
<div id="MainArea">
<s:form action="reply_addUI"  cssstyle="margin: 0; padding: 0;" method="post">
	<div id="PageHead"></div>
	...
	<center>
		<div class="ItemBlock_Title1">
			<div width=85% style="float:left">
				...
				<font class="MenuPoint"> &gt; </font>
				<s:a action="forum_show?id=%{forum.id}" namespace="/">${forum.name }见问题</s:a>
				<font class="MenuPoint"> &gt;&gt; </font>
				帖子回复
			</div>
		</div>
		<div class="ItemBlockBorder">
			<table border="0" cellspacing="1" cellpadding="1" width="100%" id="InputArea">
				<tr>
					...
					<td class="InputAreaBg"><div class="InputContent">${tile }</div></td>
				</tr>
				<tr height="240">
