...
<div id="MainArea">
	...
	<center>
		<div class="ItemBlock_Title1" style="width: 98%;">
			...
			<font class="MenuPoint"> &gt; </font>
			${name}
			<span style="margin-left:30px;"><s:a action="topic_addUI?forumId=%{ id }"  namespace="/">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<s:iterator value="topicList">
					<tr height="35" id="d0" class="template">
						...
						<td class="Topic"><s:a cssClass="Default" action="topic_show?id=%{ id }" namespace="/">${title}</s:a></td>
